...
namespace Azure.Mcp.Tools.WebPubSub.LiveTests;

public sealed class WebPubSubCommandTests(ITestOutputHelper output, TestProxyFixture fixture) : RecordedCommandTestsBase(output, fixture)
{
    ...
    [Fact]
    public async Task Should_get_webpubsub_runtimes_by_subscription_id()
    {
        var result = await CallToolAsync(
            "webpubsub_runtime_get",
    ...
    [Fact]
    public async Task Should_get_webpubsub_runtimes_by_subscription_name()
    {
        var result = await CallToolAsync(
            "webpubsub_runtime_get",
        ...
        var runtimes = result.AssertProperty("runtimes");
        Assert.Equal(JsonValueKind.Array, runtimes.ValueKind);
        // Note: Array might be empty if no Web PubSub runtimes exist in subscription
    }

    [Fact]
    public async Task Should_get_webpubsub_runtimes_by_subscription_name_with_tenant_id()
    {
        var result = await CallToolAsync(
            "webpubsub_runtime_get",
    ...
    [Fact]
    public async Task Should_get_webpubsub_runtimes_by_subscription_name_with_tenant_name()
    {
    ...
    [Fact]
    public async Task Should_get_webpubsub_runtimes_by_subscription_with_resource_group()
    {
        Assert.SkipWhen(Settings.IsServicePrincipal, TenantNameReason);
    ...
    [Fact]
    public async Task Should_get_webpubsub_runtime_detail()
    {
